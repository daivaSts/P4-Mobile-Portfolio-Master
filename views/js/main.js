...
// The code for sliding background pizzas was pulled from Ilya's demo found at:
...
function updatePositions() {
    ...
    var phase,n;
    for (n = 0; n < 13; n += 1) {
        phase = items[n].basicLeft - 600  + 100 * Math.sin(scrolls + (n % 5));
